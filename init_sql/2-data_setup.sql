...
INSERT INTO IMOVEL (RUA, NUMERO, COMPLEMENTO, BAIRRO, CEP, CIDADE, LOCADOR, EH_PROPRIETARIO, PRECO, AREA, NRO_QUARTOS, NRO_SALAS, NRO_BANHEIROS, DESCRICAO_GERAL)
    VALUES ('Rua Jacinto Favoreto', 512, 'Apto 51', 'Jardim Lutfalla', '13560515','Sao Carlos','11111111111',FALSE, 700.0, 90.0, 2, 1, 1, 'Apartamento novo, com duas vagas. Dois quartos muito bons para estudantes devido a otima localização.');
-- Kazalbe - Proprietario    
INSERT INTO IMOVEL (RUA, NUMERO, COMPLEMENTO, BAIRRO, CEP, CIDADE, LOCADOR, EH_PROPRIETARIO, PRECO, AREA, NRO_QUARTOS, NRO_SALAS, NRO_BANHEIROS, DESCRICAO_GERAL)
    VALUES ('Rua Episcopal', 2220, NULL, 'Centro', '11111111', 'Sao Carlos','44455566677', TRUE, 2399.99, 108.9, 4, 2, 2, 'Casa historica reformada para abrigar uma nova familia! Otimo estado e mobilias recem compradas! Venha morar na historia!');
